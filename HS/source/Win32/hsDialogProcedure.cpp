...
INT_PTR CALLBACK hsDialogProcedure(HWND hDlg,UINT uMsg,WPARAM wParam,LPARAM lParam)
{
 ...
 {
 case WM_INITDIALOG:
 // ѕроцедура диалогового окна должна вернуть TRUE, чтобы указать системе установить клавиатурный фокус на элемент управлени€ указанный в wParam. »наче она должна вернуть FALSE, чтобы предотвратить установку клавиатурного фокуса по-умолчанию. (ѕриложение может возвращать FALSE только, если оно установило клавиатурный фокус на один из элементов управлени€ диалогового окна).
 ...
 case WM_HOTKEY: // Ќет возвращаемого значени€ (No return value).
  {
