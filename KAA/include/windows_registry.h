...
namespace KAA
{
	namespace system
	{
		...
		private:
			...
			std::unique_ptr<registry_key> icreate_key(root_key section, const std::wstring& sub_key, key_options options, const key_access& desired_access, const void* desired_security) override;
		};
	}
}
