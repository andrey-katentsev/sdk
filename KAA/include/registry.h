...
namespace KAA
{
	namespace system
	{
		...
		public:
			...
			std::auto_ptr<registry_key> open_key(root_key section, const std::wstring& sub_key, const key_access& desired_access);
			std::auto_ptr<registry_key> create_key(root_key section, const std::wstring& sub_key, key_options options, const key_access& desired_access, const void* desired_security = nullptr);

		private:
			virtual std::auto_ptr<registry_key> iopen_key(root_key section, const std::wstring& sub_key, const key_access& desired_access) = 0;
			virtual std::auto_ptr<registry_key> icreate_key(root_key section, const std::wstring& sub_key, key_options options, const key_access& desired_access, const void* desired_security) = 0;
		};
	}
}
